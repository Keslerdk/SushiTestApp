...
class CarListAdapter(private val onItemClick : (id: Long) -> Unit) : ListAdapter<CarCard, CarListAdapter.Holder>(DiffCallback) {
    ...
    inner class Holder(private val vb: ItemCarCardBinding) : ViewHolder(vb.root) {
